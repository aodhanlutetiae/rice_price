...
# THIS CODE RUNS SUCCESSFULLY AS AN ACTION
time = datetime.now()
...
# brand=soup.find("span", class_="a-size-large product-title-word-break").text.strip()   # THIS PARSING IS WHAT FAILS. TRY TO SAVE THE SOUP TO EXAMINE
# with open('amazon_rice_price.csv', 'a') as f:
#     f.write(soup)
...
# NO NEED TO PRINT ANYTHING IN THIS CODE - COMMENT OUT
# print(res.text[:500])
